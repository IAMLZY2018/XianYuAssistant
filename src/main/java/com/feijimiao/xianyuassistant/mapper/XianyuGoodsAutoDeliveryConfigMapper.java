...
public interface XianyuGoodsAutoDeliveryConfigMapper extends BaseMapper<XianyuGoodsAutoDeliveryConfig> {
     ...
     * @return 自动发货配置
     */
    @Select("SELECT id, xianyu_account_id, xianyu_goods_id, xy_goods_id, delivery_mode, auto_delivery_content, kami_config_ids, kami_delivery_template, auto_delivery_image_url, auto_confirm_shipment, rag_delay_seconds, " +
